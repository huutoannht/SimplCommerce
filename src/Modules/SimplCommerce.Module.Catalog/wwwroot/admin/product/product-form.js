...
(function ($) {
    ...
    function ProductFormCtrl($state, $timeout, $stateParams, $http, categoryService, productService, summerNoteService, brandService, translateService) {
        ...
        vm.product = { shortDescription: '', description: '', specification: '', isPublished: true, price: 0, isCallForPricing: false, isAllowToOrder: true, promotionImageUrl: '', displayOrder: 0 };
        ...
        vm.save = function save() {
            ...
            vm.product.description = vm.product.description === null ? '' : vm.product.description;
