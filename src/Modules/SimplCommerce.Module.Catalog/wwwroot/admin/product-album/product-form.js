...
(function ($) {
    angular
        ...
        .controller('ProductAlbumFormCtrl', ProductAlbumFormCtrl);

    /* @ngInject */
    function ProductAlbumFormCtrl($state, $timeout, $stateParams, $http, categoryService, productService, summerNoteService, brandService, translateService) {
        var vm = this;
        ...
        vm.save = function save() {
            ...
            vm.product.categoryIds.push(20078);
