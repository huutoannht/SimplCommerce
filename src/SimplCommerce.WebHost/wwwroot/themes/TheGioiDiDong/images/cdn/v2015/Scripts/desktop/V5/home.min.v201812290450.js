...
function initializeClock(n) {
    var t = document.getElementById(n),
        i = setInterval(function() {
            ...
            n.total <= 0 && (clearInterval(i), $(t).parent(".time").html(""))
        }, 1e3)
}
...
function LoadCategoryStatistic() {
    $.ajax({
        ...
        cache: !0,
        success: function(n) {
            n != null && n != "" && ($(".viewallcat .mobile").html("Xem tất cả <b>" + n.phone + "<\/b> điện thoại"), $(".viewallcat .tablet").html("Xem tất cả <b>" + n.tablet + "<\/b> tablet"), $(".viewallcat .laptop").html("Xem tất cả <b>" + n.laptop + "<\/b> laptop"), $(".viewallcat .accessory").html("Xem tất cả <b>" + n.accessory + "<\/b> phụ kiện"))
        }
    })
}
