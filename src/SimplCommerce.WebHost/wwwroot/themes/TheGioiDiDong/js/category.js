...
//    (CollectParam(), advanceQuery.Count = 1, FL_LoadMore) && (FL_LoadMore = !1, POSTAjax("/aj/CategoryV5/Advance", advanceQuery, function() {
//        $(n).find(".cslder").show();
//        $(n).find(".doit").html("")
//    }, function(t) {
//        $(n).find(".cslder").hide();
...
function ShowResult(n) {
    (n === undefined && (n = !0), advanceQuery.Count = 0, FL_LoadMore) && (FL_LoadMore = !1, POSTAjax("/aj/CategoryV5/Advance", advanceQuery, function() {
        $(".loadingcover").fadeIn()
    }, function(t) {
        var i, r;
        $("#dlding").fadeOut();
        FL_LoadMore = !0;
        ReloadAdvanceFilter();
        (t == null || t == "") && (alert("Opps, something went wrong! Try it later..."), location.reload());
        i = "<div>" + t + "<\/div>";
        ...
        LazyLoad();
        n && (r = ToHash(advanceQuery), document.location.hash = r);
...
function ScrollResult() {
    var t, n;
    for ($(".loadingcover").fadeIn(), t = jQuery.extend(!0, {}, advanceQuery), n = 0; n <= advanceQuery.PageIndex; n++) t.PageIndex = n, POSTAjax("/aj/CategoryV5/Advance", t, BeforeSendAjax, function(t) {
        $("#dlding").fadeOut();
        FL_LoadMore = !0;
        (t == null || t == "") && (alert("Opps, something went wrong! Try it later..."), location.reload());
        var i = "<div>" + t + "<\/div>";
...
function ScrollResultNormal() {
    var t, n;
    for ($(".loadingcover").fadeIn(), t = jQuery.extend(!0, {}, query), n = 0; n <= query.PageIndex; n++) t.PageIndex = n, POSTAjax("/aj/CategoryV5/Product", t, BeforeSendAjax, function(t) {
        $("#dlding").fadeOut();
        FL_LoadMore = !0;
        (t == null || t == "") && (alert("Opps, something went wrong! Try it later..."), location.reload());
        var i = "<div>" + t + "<\/div>";
...
function ToHash(n) {
    ...
    var t = "";
    return n.Manufacture !== undefined && n.Manufacture != "" && (t += "m:" + n.Manufacture + "&"), n.PriceRange !== undefined && n.PriceRange > 0 && (t += "p:" + n.PriceRange + "&"), n.Feature !== undefined && n.Feature != "" && (t += "f:" + n.Feature + "&"), n.Property !== undefined && n.Property != "" && (t += "g:" + n.Property + "&"), n.Others !== undefined && n.Others != "" && (t += "r:" + n.Others + "&"), n.OrderBy !== undefined && n.OrderBy > 0 && (t += "o:" + n.OrderBy + "&"), n.PageIndex !== undefined && n.PageIndex > 0 && (t += "i:" + n.PageIndex + "&"), t[t.length - 1] == "&" && (t = t.substring(0, t.length - 1)), t
}

function MapQueryToFilter(n) {
    var t;
    n !== undefined && (n.Manufacture !== undefined && n.Manufacture != "" && (t = n.Manufacture.split(","), $(".manufacture label").each(function() {
        ...
        $(this).data("id") == n.PriceRange && ($(this).addClass("check"), $(".listprice label.all").removeClass("check"))
    }), n.Feature !== undefined && n.Feature != "" && (t = n.Feature.split(","), $(".feature .yesno label").each(function() {
        t.indexOf($(this).data("id") + "") > -1 ? $(this).addClass("check") : $(this).removeClass("check")
    })), n.Property !== undefined && n.Property != "" && (t = n.Property.split(","), $(".feature .property label").each(function() {
        t.indexOf($(this).data("id") + "") > -1 ? $(this).addClass("check") : $(this).removeClass("check")
    })), n.Others !== undefined && n.Others != "" && (t = n.Feature.split(","), $(".barpage label").each(function() {
        t.indexOf($(this).data("id") + "") > -1 ? $(this).addClass("check") : $(this).removeClass("check")
    })), n.OrderBy !== undefined && n.OrderBy > 0 && $(".filter li .sortprice label").each(function() {
        $(this).data("id") == n.OrderBy && ($(".filter li .sortprice label.check").removeClass("check"), $(this).addClass("check"))
    }))
}

function FromHash(n) {
    var u, i, r, f, e, t;
    if (n == "" || (u = n.split("&"), u.length == 0)) return null;
    i = advanceQuery;
    r = !1;
    for (f in u)(e = u[f], t = e.split(":"), t.length == 2) && (t[0] == "m" ? (i.Manufacture = t[1], r = !0) : t[0] == "p" ? (i.PriceRange = t[1], r = !0) : t[0] == "f" ? (i.Feature = t[1], r = !0) : t[0] == "g" ? (i.Property = t[1], r = !0) : t[0] == "r" ? (i.Others = t[1], r = !0) : t[0] == "o" ? (i.OrderBy = t[1], r = !0) : t[0] == "i" && (i.PageIndex = t[1], r = !0));
    return r ? i : null
}

function FromHash(n) {
    var f, e, o, t;
    if (n == "" || (f = n.split("&"), f.length == 0)) return null;
    var i = advanceQuery,
        r = !1,
        u = !1;
    for (e in f)(o = f[e], t = o.split(":"), t.length == 2) && (t[0] == "m" ? (i.Manufacture = t[1], r = !0, u = !0) : t[0] == "p" ? (i.PriceRange = t[1], r = !0, u = !0) : t[0] == "f" ? (i.Feature = t[1], r = !0, u = !0) : t[0] == "g" ? (i.Property = t[1], r = !0, u = !0) : t[0] == "r" ? (i.Others = t[1], r = !0, u = !0) : t[0] == "o" ? (i.OrderBy = t[1], r = !0, u = !0) : t[0] == "i" && (i.PageIndex = t[1], r = !0), i.IsAdvanced = u);
    return r ? i : null
}

function ReloadAdvanceFilter() {
    FL_LoadMore && (FL_LoadMore = !1, POSTAjax("/aj/CategoryV5/AdvanceFilter", advanceQuery, BeforeSendAjax, function(n) {
        $("#dlding").fadeOut();
        FL_LoadMore = !0;
        (n == null || n == "") && (alert("Opps, something went wrong! Try it later..."), location.reload());
...
function RemoveFilter(n, t, i) {
    ...
    }) : t == 2 ? ($(".listprice label.check").removeClass("check"), $(".listprice label.all").removeClass("check")) : t == 3 ? $(".feature .property label.check").each(function() {
        $(this).data("id") == i && $(this).removeClass("check")
...
function RemoveAllFilter(n) {
    var t = $(n).parents("div");
    t.hasClass("manufacture") ? t.find("label.all").click() : t.hasClass("feature") && (t.find(".check").removeClass("check"), CountAdvance(".feature"))
}

function More(n) {
    (n === undefined && (n = !1), FL_LoadMore) && (FL_LoadMore = !1, n ? advanceQuery.PageIndex = parseInt(advanceQuery.PageIndex) + 1 : query.PageIndex = parseInt(query.PageIndex) + 1, $("a.viewmore").addClass("loading").html('<p class="cslder"><span class="cswrap"><span class="csdot"><\/span><span class="csdot"><\/span><span class="csdot"><\/span><\/span><\/p>'), $("a.viewmore .cslder").show(), POSTAjax(n ? "/aj/CategoryV5/Advance" : "/aj/CategoryV5/Product", n ? advanceQuery : query, function() {}, function(t) {
        var i, r;
        if ($("#dlding").fadeOut(), FL_LoadMore = !0, t == null || t == "") {
            $("a.viewmore").remove();
            return
        }
        i = "<div>" + t + "<\/div>";
        ...
        LazyLoad();
        n ? (r = ToHash(advanceQuery), document.location.hash = r) : document.location.hash = "i:" + query.PageIndex
    }, ErrorAjax, !0))
}
...
function qcp_createHtml(n) {
    var t, r, i;
    $("body .quickCpr").length == 0 && (t = "", r = "sản phẩm", n == 42 ? r = "điện thoại" : n == 44 ? r = "laptop" : n == 522 && (r = "máy tính bảng"), t += '<div class="stickcompare">', t += '<div class="small">', t += "<ul>", t += '<li id="btnMinimize" onclick=qcp_changeMinimize();><i><\/i> Thu nhỏ<\/li>', t += "<li><span>|<\/span><\/li>", t += "<li onclick='qcp_off();'>Tắt so sánh<\/li>", t += "<\/ul>", t += "<\/div>", t += '<ul class="comlist">', t += '<li id="qPr1">', t += "<\/li>", t += '<li id="qPr2">', t += "<\/li>", t += '<li id="qPr3">', t += "<\/li>", t += "<li>", t += '<a href="javascript:void(0);" class="viewdisable viewfullcomp">So sánh chi tiết<\/a>', t += '<span class="textmin">Tối thiểu 2 sản phẩm<\/span>', t += "<\/li>", t += "<\/ul>", t += "<\/div>", $("body").append(t), i = "", i += '<form action="javascript:void(0)">', i += '<input type="search" name="" placeholder="So sánh với ' + r + ' gì..." onkeyup="qcp_SuggestCompare(this,event)" >', i += '<button type="submit"><i class="icontgdd-scomp"><\/i><\/button>', i += "<\/form>", $("#qPr1").html(i), $("#qPr2").html(i), $("#qPr3").html(i))
}

function qcp_checkAdd(n, t) {
    var i = !0;
    return $(".comlist li").each(function() {
        n == $(this).attr("data-id") && (i = !1, alert('Bạn đã thêm sản phẩm "' + t + '" vào so sánh'))
    }), i
}

function qcp_addProdQcp(n, t, i, r) {
    if (r != !0 && (r = !1), !(parseInt(n) > 0)) return !1;
    if (g_qcp_prod1 != "" && g_qcp_prod2 != "" && g_qcp_prod3 != "") return alert("Bạn đã chọn 3 sản phẩm để so sánh"), $(".stickcompare").show(), qcp_maximize(), !1;
    if (!qcp_checkAdd(n, i)) return $(".stickcompare").show(), qcp_maximize(), !1;
    ...
    $.ajax({
        ...
        success: function(i) {
            if (i != "") {
                if (r == !1 ? (qcp_saveCookie(n, t), qcp_maximize()) : qcp_minimize(), $(".stickcompare").show(), $(".stickcompare .comlist input").each(function() {
                        $(this).val("")
                    }), g_qcp_cate = parseInt(t), g_qcp_prod1 == "") {
                    g_qcp_prod1 = n;
                    $("#qPr1").attr("data-id", n);
...
function qcp_clearProdQcp(n) {
    var h = $(n).parent().attr("id"),
        s = $(n).parent().attr("data-id"),
        c = $(n).parent().attr("data-cate"),
        l, r, u, t;
    if (c = parseInt(c), l = "sản phẩm", c == 42 ? l = "điện thoại" : c == 44 ? l = "laptop" : c == 522 && (l = "máy tính bảng"), r = "", r += '<form action="javascript:void(0)" >', r += '<input type="search" name="" placeholder="So sánh với ' + l + ' gì..." onkeyup="qcp_SuggestCompare(this,event)" >', r += '<button type="submit"><i class="icontgdd-scomp"><\/i><\/button>', r += "<\/form>", h != "" && ($("#" + h).html(""), h == "qPr1" ? (g_qcp_prod1 = "", $("#qPr1").attr("data-id", ""), $("#qPr1").attr("data-cate", ""), $("#qPr1").html(r)) : h == "qPr2" ? (g_qcp_prod2 = "", $("#qPr2").attr("data-id", ""), $("#qPr2").attr("data-cate", ""), $("#qPr2").html(r)) : h == "qPr3" && (g_qcp_prod3 = "", $("#qPr3").attr("data-id", ""), $("#qPr3").attr("data-cate", ""), $("#qPr3").html(r))), $(".comlist .Cpr").length == 0 && $(".stickcompare").hide(), qcp_showDescript(), $(".comlist li").last().find("a").attr("href", qcp_getLink()), u = getCookie("ck_qcp"), u != null && u != "" && typeof u != "undefined") {
        ...
        var a = u.split("l"),
            ...
            o = a[2].split("-"),
            i = "";
        for (t = 0; t < f.length - 1; t++) f[t] == s && (f[t] = ""), i += f[t] + "-";
        for (f[2] == s && (f[2] = ""), i += f[2] + "l", t = 0; t < e.length - 1; t++) e[t] == s && (e[t] = ""), i += e[t] + "-";
        for (e[2] == s && (e[2] = ""), i += e[2] + "l", t = 0; t < o.length - 1; t++) o[t] == s && (o[t] = ""), i += o[t] + "-";
        o[2] == s && (o[2] = "");
        i += o[2];
...
function qcp_saveCookie(n, t) {
    var u, r, i;
    if (n = parseInt(n), t = parseInt(t), isNaN(n) || isNaN(t)) return !1;
    u = getCookie("ck_qcp");
    ...
    if (t == 42)
        ...
        for (i = 0; i < o.length; i++)
            if (o[i] == "") {
                o[i] = n;
                break
            } for (r = "", i = 0; i < f.length - 1; i++) r += f[i] + "-";
    for (r += f[2] + "l", i = 0; i < e.length - 1; i++) r += e[i] + "-";
    for (r += e[2] + "l", i = 0; i < o.length - 1; i++) r += o[i] + "-";
    r += o[2];
    CreateCookie("ck_qcp", r, 1)
}

function qcp_checkCookie(n) {
    var i = getCookie("ck_qcp"),
        t, u, f;
    if (i == null || i == "" || typeof i == "undefined") i = "--l--l--", CreateCookie("ck_qcp", i, 1);
    else {
        qcp_minimize();
        var r = i.split("l"),
            e = r[0].split("-"),
            o = r[1].split("-"),
            s = r[2].split("-");
        if (n == 0 && (n = qcp_checkCate(r)), t = null, g_qcp_cate = n, n == 0 || (n == 42 ? t = e : n == 44 ? t = o : n == 522 && (t = s)), t != null)
            for (u = 0; u < t.length; u++) f = parseInt(t[u]), f > 0 && qcp_addProdQcp(f, g_qcp_cate, "", !0)
    }
}

function qcp_checkCate(n) {
    for (var i = n[0].split("-"), r = n[1].split("-"), u = n[2].split("-"), t = 0; t < i.length; t++)
        if (parseInt(i[t]) > 0) return 42;
    for (t = 0; t < r.length; t++)
        if (parseInt(r[t]) > 0) return 44;
    for (t = 0; t < u.length; t++)
        if (parseInt(u[t]) > 0) return 522;
    return 0
}
...
function qcp_SuggestCompare(n, t) {
    ...
    if (i = ".search-suggestion-list li", t.which == 13 ? $(i + ".selected").find("a").click() : t.which != 40 && t.which != 38 && $.ajax({
            ...
            success: function(n) {
                var t, i;
                n != null && n != "" && n != "[object XMLDocument]" && (t = "", t = '<div class="search-suggestion-wrapper clearfix"><ul class="search-suggestion-list nolist clearfix">', t += n, t += "<\/ul><\/div>", $("#" + qcp_currID + " form").find(".search-suggestion-wrapper").remove(), $("#" + qcp_currID + " form").append(t), i = $("#" + qcp_currID + " form").find("input").width() + 15, $(".search-suggestion-list").css("width", i + "px"), t != "" && $(".popAddProd").css("height", "525px"), $(document).click(function(n) {
                    var t = $(n.target);
...
function qcp_getLink() {
    var i = "",
        n = "",
        r, t, u;
    if (g_qcp_cate == 42 ? n = "/dtdd/" : g_qcp_cate == 522 ? n = "/may-tinh-bang/" : g_qcp_cate == 44 && (n = "/laptop/"), n != "") return r = $(".comlist .Cpr").length, r == 1 ? (t = $(".comlist .Cpr").first(), i += n + "so-sanh-" + $(t).attr("data-lnk")) : r == 2 ? (t = $(".comlist .Cpr").first(), u = $(".comlist .Cpr:eq(1)"), i += n + $(t).attr("data-lnk") + "-vs-" + $(u).attr("data-lnk")) : r == 3 && (t = $(".comlist .Cpr").first(), u = $(".comlist .Cpr:eq(1)"), i += n + $(t).attr("data-lnk") + "-vs-" + $(u).attr("data-lnk") + "?Prod=" + $("#qPr3").attr("data-id")), i
}
...
function qcp_showDescript() {
    $(".stickcompare .comlist input").length == 2 ? ($(".stickcompare .comlist li p").hide(), $(".stickcompare").css("max-height", "126px")) : ($(".stickcompare .comlist li p").show(), $(".stickcompare").css("max-height", "180px"))
}
...
$(window).load(function() {
    ...
    $(".criteria").click(function() {
        ...
        $("body,html").animate({
            scrollTop: $(".barpage").position().top -100
        }, 600)
    });
    ...
    $(".manufacture label").click(function() {
        $(this).hasClass("all") ? ($(".manufacture label").removeClass("check"), $(this).addClass("check")) : ($(this).toggleClass("check"), $(".manufacture label.all").removeClass("check"));
    ...
    $(".listprice label").click(function() {
        $(this).hasClass("check") || ($(".listprice label.check").removeClass("check"), $(this).addClass("check"), CountAdvance(".listprice"))
    });
    ...
    InitEvent();
    location.hash != "" ? (i = location.hash.replace("#", ""), i != "" ? (n = FromHash(i), n != null ? n.IsAdvanced ? (Object.assign(advanceQuery, n), console.log(JSON.stringify(n)), console.log(JSON.stringify(advanceQuery)), advanceQuery.PageIndex > 0 ? ScrollResult() : (ShowResult(!1), waitDefaultScroll = !1, $(".loadingcover").fadeOut()), MapQueryToFilter(advanceQuery)) : (query.PageIndex = n.PageIndex, ScrollResultNormal()) : (waitDefaultScroll = !1, $(".loadingcover").fadeOut())) : (waitDefaultScroll = !1, $(".loadingcover").fadeOut())) : (waitDefaultScroll = !1, $(".loadingcover").fadeOut())
});
waitDefaultScroll = !0;
