...
(function(root, factory) {
    ...
    var defaults = {
        ...
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" {action}="{date}" data_url="{class}">{value}</li>',
        MONTH_ITEM_TPL = '<li ' + ITEM_STYLE + ' ' + ITEM_MONTH + '>{m}d.</li>',
    ...
    Calendar.prototype = {
                ...
                exec = {
                    prev: function() {
                        ...
                        $dis.animate({
                            ...
                            $dis.prepend($prevItem).css('margin-left', '-114%');
                    ...
                    next: function() {
                        ...
                        $dis.animate({
                            ...
                            $dis.append($nextItem).css('margin-left', '-114%');
        ...
        showLabel: function(event, view, date, data) {
            ...
            $lbl.css({
                ...
                zIndex: this.options.zIndex + 9999999
            }).show();
        },
        hasLabel: function() {
