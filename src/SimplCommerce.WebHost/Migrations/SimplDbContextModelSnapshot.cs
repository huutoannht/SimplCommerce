            ...
            modelBuilder.Entity("SimplCommerce.Module.Catalog.Models.Product", b =>
                {
                    ...
                    b.Property<long?>("PromotionImageId");
            ...
            modelBuilder.Entity("SimplCommerce.Module.Core.Models.WidgetZone", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, IsPublished = false, Name = "Home Featured" },
                        new { Id = 2L, IsPublished = false, Name = "Home Main Content" },
                        new { Id = 3L, IsPublished = false, Name = "Home After Main Content" }
                    );
                });
            ...
            modelBuilder.Entity("SimplCommerce.Module.Catalog.Models.Product", b =>
                {
                    ...
                    b.HasOne("SimplCommerce.Module.Core.Models.Media", "PromotionImage")
                        .WithMany()
